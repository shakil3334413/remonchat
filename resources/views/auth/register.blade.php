                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="f_name" type="text" class="form-control @error('f_name') is-invalid @enderror" name="f_name" value="{{ old('f_name') }}"  autocomplete="f_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="l_name" type="text" class="form-control @error('l_name') is-invalid @enderror" name="l_name" value="{{ old('l_name') }}"  autocomplete="l_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <option value="{{$dis->division_id}}">{{$dis->name}}</option>
                                @endforeach
                            </select>
                            @error('district')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="file" name="image" class="form-control" multiple hidden>
                            </div>
                        </div>
                        <div class="form-group row">
